...
- Grid **extent** is defined in WGS84 (for Folium overlay compatibility)
- Grid **dimensions** are computed from UTM measurements: `nx = round(width_m / resolution)`
- Cell **queries** (KD-tree, raster reads) transform cell centers to UTM on-the-fly
