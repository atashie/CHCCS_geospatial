...
First in an editorial series; precedes the demographics
...
<div class="scroll-container">
  ...
  <div class="step" data-step="0">
    ...
    community impact, and geographic conditions. Environmental factors are
    one component of the geographic conditions that should inform this
    decision: conditions that affect student health and long-term facility
    viability.</p>
  </div>
  ...
  <div class="step" data-step="1">
    ...
    <p>Three environmental factors are examined across all 11 elementary schools:</p>
  ...
  <!-- ========== FLOOD ZONES (Steps 2-3) ========== -->

  <!-- Step 2: Understanding Flood Zones -->
  <div class="step" data-step="2">
    <div class="step-number">3</div>
    <h2>Understanding Flood Zones</h2>
    <ul style="margin:8px 0 8px 20px;line-height:1.8;">
      <li><strong>100-year flood zone:</strong> 1% annual chance of flooding &mdash;
      that translates to a <em>26% chance over a 30-year mortgage</em></li>
      <li><strong>500-year flood zone:</strong> 0.2% annual chance of flooding</li>
      <li>These are <em>predictable recurring risks</em>, not rare events</li>
    </ul>
    <h3>Chapel Hill&rsquo;s Flood History</h3>
    <ul style="margin:8px 0 8px 20px;line-height:1.8;">
      <li>At least <strong>3 severe floods in 30 years</strong> (Fran 1996, Floyd 1999, Chantal 2025)</li>
      <li>Tropical Storm Chantal was a <strong>1,000-year rainfall event</strong> causing an
      estimated <strong>$54&nbsp;million in damage</strong></li>
      <li>Most significant damage occurred in areas of known flood risk</li>
  ...
  <!-- ========== TRAFFIC AIR POLLUTION (Steps 4-6) ========== -->

  <!-- Step 4: TRAP & Children's Health (merged) -->
  <div class="step" data-step="4">
    ...
    <p><em>The trend is toward more restrictive siting rules for children&rsquo;s
    health.</em></p>
    <p>Chapel Hill has no such policy, but the data are clear: <strong>proximity
  ...
  <div class="step" data-step="6">
    ...
    exposure &mdash; bordered by US 15-501 and NC-54.</p>
    <p><span class="fpg-label">FPG</span>&rsquo;s current site ranks #2, but its
  ...
  <!-- ========== URBAN HEAT ISLAND (Steps 7-9) ========== -->

  <!-- Step 7: What Is Urban Heat? -->
  <div class="step" data-step="7">
    ...
    <p>Heat vulnerability was estimated using ESA WorldCover land classification
  ...
  <div class="step" data-step="10">
    ...
    <p>Environmental conditions are interconnected with built and natural
    environment factors that have significant impact on health outcomes,
    academic performance, and financial savings.</p>
    <h3>Flood Risk</h3>
    <p>All 3 closure candidates have <strong>zero flood exposure</strong>.
    Only FPG and Rashkis have properties overlapping flood zones.
    FPG&rsquo;s current site is a flood liability that should not be
    maintained post-relocation.</p>
    <h3>Traffic Pollution</h3>
    <p><span class="ephesus-label">Ephesus</span> and
    <span class="seawell-label">Seawell</span> have low exposure.
    <span class="glenwood-label">Glenwood</span> and
    <span class="fpg-label">FPG (current)</span> have far greater exposure
    than all other schools. FPG&rsquo;s new site would dramatically improve
    pollution exposure.</p>
    <h3>Urban Heat</h3>
...
function handleStep(idx) {{
  ...
  switch(idx) {{
    ...
    case 1: // What Is Analyzed
      layers.district.addTo(map);
      layers.schools.addTo(map);
      districtView();
      break;

    case 2: // Understanding Flood Zones (merged)
      layers.district.addTo(map);
    ...
    case 4: // TRAP & Children's Health (merged)
      layers.district.addTo(map);
      layers.schools.addTo(map);
    ...
    case 6: // TRAP Bar Chart
      showTrapChart();
      break;

    case 7: // What Is Urban Heat?
      layers.district.addTo(map);
      layers.schools.addTo(map);
      districtView();
      break;
    ...
    case 9: // UHI Bar Chart
      showUhiChart();
      break;

    case 10: // Env Factors Summary
      layers.district.addTo(map);
      layers.trapNet.addTo(map);
      layers.flood500.addTo(map);
      layers.flood100.addTo(map);
