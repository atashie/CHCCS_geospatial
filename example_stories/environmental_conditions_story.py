...
def build_html(data: dict) -> str:
    """Build the 18-step environmental conditions scrollytelling HTML."""
...
<div class="scroll-container">
  ...
  <div class="step" data-step="0">
    ...
    <h2>Environmental Conditions Across CHCCS Schools</h2>
    ...
    and community impact. But there are other factors that should inform
    this decision: <strong>environmental and geographic conditions</strong>
    that affect student health and long-term infrastructure viability.</p>
    ...
    want to state clearly: <strong>no school community should ever be
    permanently closed</strong>.
    ...
    <p>Now, we start by analyzing the environmental and geographic conditions.</p>
  </div>
  ...
  <div class="step" data-step="3">
    ...
    <p>That is at least three severe flood events in roughly 30 years &mdash;
  ...
  <!-- Step 4: Schools at Risk: FPG & Rashkis -->
  ...
  <!-- Step 5: FPG Relocation -->
  <div class="step" data-step="5">
    <div class="step-number">6</div>
    <h2>FPG Relocation &amp; the Liability Question</h2>
    ...
    acreage in a 100-year flood zone &mdash; becomes a liability.</p>
    <p>If FPG is to be relocated, is there any good rationale for keeping a
    property that is at documented risk of flooding?</p>
  </div>

  <!-- Step 6: Climate Resilience of Closure Candidates -->
  <div class="step" data-step="6">
    <div class="step-number">7</div>
    <h2>Climate Resilience of Closure Candidates</h2>
    ...
    <p>These are climate-resilient sites. Perhaps schools with greater climate
    resilience should be maintained.</p>
    <div class="insight">
      <strong>Key finding:</strong> The only schools with flood exposure (FPG
      and Rashkis) are not on the closure list. All three closure candidates
      are on flood-safe ground.
    </div>
  </div>

  <!-- ========== TRAFFIC AIR POLLUTION (Steps 7-12) ========== -->

  <!-- Step 7: TRAP & Children's Health -->
  ...
  <!-- Step 9: TRAP Methodology -->
  <div class="step" data-step="9">
    <div class="step-number">10</div>
    <h2>TRAP Methodology (Brief)</h2>
    <p>We modeled TRAP exposure using road network data from OpenStreetMap,
    NCDOT traffic counts, and an exponential decay function (pollution drops
    ~50% within 230m of a road). Tree canopy mitigation reduces exposure by
    up to 56% per published literature.</p>
    <div class="source">
  ...
  <!-- Step 10: Raw TRAP Heatmap -->
  <div class="step" data-step="10">
    <div class="step-number">11</div>
    <h2>Raw Traffic Pollution</h2>
    <p>Raw traffic pollution index across the district. Hotter colors indicate
    higher cumulative exposure from nearby roads.</p>
    <p>Major corridors (I-40, US 15-501, MLK Blvd) create clear pollution
    corridors that extend into school neighborhoods.</p>
  </div>

  <!-- Step 11: Net TRAP with Tree Canopy -->
  <div class="step" data-step="11">
    <div class="step-number">12</div>
    <h2>Net Pollution (After Tree Canopy)</h2>
    <p>After accounting for tree canopy mitigation, some areas see significant
    reduction. Mature tree cover absorbs and disperses pollutants.</p>
    <p>However, schools near major roads remain elevated even with canopy.
    Trees help, but they cannot fully compensate for proximity to heavy
    traffic.</p>
  </div>

  <!-- Step 12: TRAP Bar Chart -->
  ...
  <!-- ========== URBAN HEAT ISLAND (Steps 13-15) ========== -->

  <!-- Step 13: What Is Urban Heat? -->
  ...
  <div class="step" data-step="16">
    ...
    <div class="insight">
      <strong>Bottom line:</strong> Environmental data alone does not determine
      which school should close &mdash; but it should inform the conversation.
    </div>
  </div>
...
function zoomToFpg() {{
  SCHOOL_PROPS.features.forEach(function(f) {{
    if ((f.properties.school_name || "").indexOf("Frank Porter Graham") >= 0) {{
...
function handleStep(idx) {{
  ...
  switch(idx) {{
    ...
    case 3: // Chapel Hill's Flood History
      layers.district.addTo(map);
      layers.flood500.addTo(map);
      layers.flood100.addTo(map);
      layers.schools.addTo(map);
    ...
    case 6: // Climate Resilience of Closure Candidates
      layers.district.addTo(map);
      layers.flood500.addTo(map);
      layers.flood100.addTo(map);
      layers.schoolProps.addTo(map);
    ...
    case 9: // TRAP Methodology
      layers.district.addTo(map);
      layers.schools.addTo(map);
      districtView();
      break;

    case 10: // Raw TRAP Heatmap
      layers.district.addTo(map);
    ...
    case 12: // TRAP Bar Chart
      showTrapChart();
      break;

    case 13: // What Is Urban Heat?
      layers.district.addTo(map);
      layers.schools.addTo(map);
      districtView();
      break;
    ...
    case 15: // UHI Bar Chart
      showUhiChart();
      break;

    case 16: // Environmental Summary
      layers.district.addTo(map);
      layers.trapNet.addTo(map);
      layers.flood500.addTo(map);
      layers.flood100.addTo(map);
