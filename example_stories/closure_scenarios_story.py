...
<div class="scroll-container">
  ...
  <div class="step" data-step="3">
    ...
    cost for either closure would likely be even greater, as
    accommodating entire new neighborhoods may require adding new
    buses to the fleet.</p>
  </div>
...
<div id="map-container">
  ...
  <div id="walker-panel" style="position:absolute;top:0;left:0;width:100%;height:100%;
    ...
    <div style="text-align:center;margin:0 0 8px;">
      <h3 style="margin:0 0 4px;font-size:1.15em;color:#333;">Students Living Near School</h3>
      <p style="margin:0;font-size:0.82em;color:#777;">Chapel Hill Safe Routes to School Action Plan (2025)</p>
    </div>
    <div style="display:flex;gap:16px;justify-content:center;margin:4px 0 14px;font-size:0.8em;color:#555;">
      <div style="display:flex;align-items:center;gap:4px;">
        <div style="width:16px;height:12px;background:#888;border-radius:2px;"></div>
        Within 0.5 mi
      </div>
      <div style="display:flex;align-items:center;gap:4px;">
        <div style="width:16px;height:12px;background:rgba(136,136,136,0.2);border:2px solid #888;border-radius:2px;box-sizing:border-box;"></div>
        0.5&ndash;1.0 mi
      </div>
    </div>
    <div id="walker-bars" style="max-width:500px;margin:0 auto;">
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:51.6%;background:#C62828;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:51.6%;top:0;width:48.4%;background:rgba(198,40,40,0.2);border:2px solid #C62828;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
          <span style="position:absolute;right:6px;top:2px;font-size:0.8em;color:#333;font-weight:bold;">192 (47.9%)</span>
        </div>
      </div>
      <div style="display:flex;align-items:center;margin:6px 0;">
        <div style="width:110px;font-size:0.85em;color:#333;">Scroggs</div>
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:49.0%;background:#66c2a5;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:49.0%;top:0;width:51.0%;background:rgba(102,194,165,0.2);border:2px solid #66c2a5;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
          <span style="position:absolute;right:6px;top:2px;font-size:0.8em;color:#333;font-weight:bold;">192 (47.4%)</span>
        </div>
      </div>
      <div style="display:flex;align-items:center;margin:6px 0;">
        <div style="width:110px;font-size:0.85em;color:#333;">Estes Hills</div>
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:17.2%;background:#377eb8;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:17.2%;top:0;width:38.0%;background:rgba(55,126,184,0.2);border:2px solid #377eb8;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
      ...
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:18.2%;background:#FF8F00;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:18.2%;top:0;width:30.7%;background:rgba(255,143,0,0.2);border:2px solid #FF8F00;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
      ...
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:33.3%;background:#a65628;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:33.3%;top:0;width:9.9%;background:rgba(166,86,40,0.2);border:2px solid #a65628;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
      ...
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:33.9%;background:#f781bf;height:100%;border-radius:3px 0 0 3px;"></div>
          <div style="position:absolute;left:33.9%;top:0;width:6.8%;background:rgba(247,129,191,0.2);border:2px solid #f781bf;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
      ...
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:31.3%;background:rgba(21,101,192,0.2);border:2px solid #1565C0;height:100%;border-radius:3px;box-sizing:border-box;"></div>
      ...
      <div style="display:flex;align-items:center;margin:6px 0;">
        ...
        <div style="flex:1;background:#eee;border-radius:3px;height:22px;position:relative;">
          <div style="position:absolute;left:0;top:0;width:3.1%;background:#2E7D32;height:100%;border-radius:3px 0 0 3px;min-width:4px;"></div>
          <div style="position:absolute;left:3.1%;top:0;width:11.5%;background:rgba(46,125,50,0.2);border:2px solid #2E7D32;border-left:none;height:100%;border-radius:0 3px 3px 0;box-sizing:border-box;"></div>
          <span style="position:absolute;right:6px;top:2px;font-size:0.8em;color:#333;font-weight:bold;">28 (7.0%)</span>
        </div>
      </div>
    </div>
    <p style="text-align:center;margin:8px 0 0;font-size:0.75em;color:#999;">
      Total bar = students within 1 mile; percentages relative to school enrollment</p>
    <div class="source" style="margin:16px 24px 0;">
      <strong>Source:</strong> Chapel Hill Safe Routes to School Action Plan
